<template>
  <div class="container pb-15 pb-md-17 mt-0 mt-lg-8 mt-xl-10 mt-xxl-10">
    <!--/.row -->
    <div class="row">
      <div class="col-md-10 offset-md-1 col-lg-8 offset-lg-2 mx-auto text-center" data-aos="fade-up" data-aos-once="true"
      data-aos-delay="300">
    ...
    <!-- /.nav-tabs -->
    <div class="tab-content mt-6 mt-lg-8" data-aos="zoom-in" data-aos-once="true" data-aos-delay="600">
      <div v-for="(service, i) in services" :key="`tabconten-${i}`"
        :class="`tab-pane fade  ${activeTab == i ? 'show active' : ''}`">
