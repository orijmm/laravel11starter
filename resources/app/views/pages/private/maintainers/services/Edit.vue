...
export default defineComponent({
    ...
    setup() {
        ...
        const table = reactive({
            ...
            actions: {
                edit: {
                    ...
                    icon: "fa fa-edit",
                    showName: false,
                    to: toUrl(`/pages/services/${route.params.id}/showitem/{id}`),
        ...
        function onSubmitItem() {
            service.handleCreate('add-item', reduceProperties(formItem, [], 'id'), `/pages/services/${form.id}/storeitem`).then(() => {
