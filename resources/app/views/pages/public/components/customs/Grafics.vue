<template>
    <div
        class="rounded-[2.25rem] sm:rounded-xl bg-white shadow-lg sm:shadow-md transform lg:-translate-y-12 px-4 sm:px-6 lg:px-0 py-6 pb-20 sm:py-8 relative max-w-screen-xl m-auto my-10">
